...
public class Player : MonoBehaviour
{
    ...
    public AudioClip healSound; //플레이어 힐 사운드

    public AudioClip StrikeSword; //일자 스트라이크 사운드
    ...
    {
        Hp += amount;
        GameManager.Instance.SoundMgr.SoundPlay("sfx","힐 사운드",healSound);
    ...
    public void ShowDefeatUI()
    {
        ...
        GameManager.Instance.SoundMgr.SoundPlay("sfx","사망 효과음",dieSound);
    }
    ...
    public void ShootSward()
    {
        ...
        GameManager.Instance.SoundMgr.SoundPlay("sfx","일자스트라이크 사운드",StrikeSword);
